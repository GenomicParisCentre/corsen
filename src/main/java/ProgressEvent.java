...
public class ProgressEvent {
  ...
  public static final int START_WRITE_RPLOT_MESSENGERS_EVENT = 3;
  public static final int START_WRITE_RPLOT_MITOS_EVENT = 4;
  public static final int START_WRITE_RPLOT_CUBOIDS_EVENT = 5;
  public static final int START_CALC_CUBOIDS_EVENT = 6;
  public static final int START_WRITE_FULLRESULT_MESSAGERS_EVENT = 7;
  public static final int START_WRITE_FULLRESULT_CUBOIDS_EVENT = 8;
  public static final int START_WRITE_RRESULT_CUBOIDS_EVENT = 9;
  public static final int PROGRESS_CALC_CUBOIDS_EVENT = 100;
