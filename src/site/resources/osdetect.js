...
if (!(pf.indexOf('Win')!=-1 || pf.indexOf('Linux i')!=-1)) {
  ...
  if (pf.indexOf('MacIntel')!=-1) {
    ...
    '<div style="float: right; margin: 10px 10px 20px 20px; padding: 5px; border: 1px solid #999; background-color: #99CCFF;">' +
      ...
      '<div><p><b>Warning:</b> Corsen application is currently experimental for Mac OS X.'+ 
      ' You need Mac OS X Snown Leopard (10.6) and Java 6 to run Corsen. No error message will be shown if Corsen can\'t be launched.'+
